...
struct GekkoSession {
    ...
    virtual void SetStateCallbacks(GekkoStateCallbacks* callbacks) = 0;
...
namespace Gekko {
    ...
    public:
        ...
        void SetStateCallbacks(GekkoStateCallbacks* callbacks) override;
	...
	private:
        ...
        GekkoStateCallbacks _state_callbacks = {0};
	};

...
typedef struct {
    ...
    CommandState cmd_hit_stop_backup;
    CommandState cmd_register_0;
    ...
    CollisionOverlapIndex graphic_overlap_index;
...
typedef struct {
    ...
    s16 stun_scaling;
    s16 guts_scaling;
    s16 received_strike_scaling;
    s16 received_throw_scaling;
    s16 received_stun_scaling;
    u8 parry_flag;
    u8 parry_point;
    s16 dm_vital_backup;
    u8 dm_refrect;

/**
 * @file PPGFile.h
 * @brief PPG/PPL/PPX file format parser for textures, palettes, and compressed chunks.
 *
 * Handles loading, decompression, and GPU handle management for the
 * game's proprietary packed-graphics file formats. Supports LZ77 and
 * zlib compressed data, multiple pixel formats, and transparency maps.
 *
...
s32 ppgSetupPalChunk(Palette* pch, u8* adrs, s32 size, s32 ixNum1st, s32 num, s32 unused1);
...
s32 ppgSetupPalChunkDir(Palette* pch, PPLFileHeader* ppl, u8* adrs, s32 ixNum1st, s32 unused1);

 ...
 *
 * Declares global texture/palette/data-list instances used across the
 * game's screen, menu, opening, and background subsystems. Provides
 * functions to initialise and purge these resources from VRAM.
 *

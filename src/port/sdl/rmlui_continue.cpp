...
extern "C" void rmlui_continue_init(void) {
    ...
    SDL_LogDebug(SDL_LOG_CATEGORY_APPLICATION, "[RmlUi Continue] Data model registered");
}
...
extern "C" void rmlui_continue_show(void) {
    rmlui_wrapper_show_game_document("continue");
}

extern "C" void rmlui_continue_hide(void) {
    rmlui_wrapper_hide_game_document("continue");
}

...
#include "port/arm/arm_app.h"
#include "arcade/arcade_balance.h"
#include "main.h"
#include "port/arm/arm_display.h"
...
static bool full_init() {
    ...
    GameRendererVtable_Init(RENDERER_SOFTWARE);
...
static void end_frame() {
    ...
    const uint32_t* canvas_pixels = (const uint32_t*)sdl_sw_get_canvas(&canvas_w, &canvas_h, &canvas_pitch_bytes);

...
void RmlUi_Renderer_GCM::RenderGeometry(Rml::Vertex* vertices, int num_vertices, int* indices, int num_indices,
                                        Rml::TextureHandle texture, const Rml::Vector2f& translation) {
    // TODO: implement cellGcmSetDrawElements mapping
}

Rml::CompiledGeometryHandle RmlUi_Renderer_GCM::CompileGeometry(Rml::Vertex* vertices, int num_vertices, int* indices,
                                                                int num_indices, Rml::TextureHandle texture) {
    return 0; // Returning 0 means RmlUi will fallback to RenderGeometry
}

void RmlUi_Renderer_GCM::RenderCompiledGeometry(Rml::CompiledGeometryHandle geometry,
...
bool RmlUi_Renderer_GCM::LoadTexture(Rml::TextureHandle& texture_handle, Rml::Vector2i& texture_dimensions,
                                     const Rml::String& source) {
    return false;
}

bool RmlUi_Renderer_GCM::GenerateTexture(Rml::TextureHandle& texture_handle, const Rml::byte* source,

...
extern "C" void ReplayPicker_Open(int mode) { (void)mode; }
extern "C" int ReplayPicker_IsOpen(void) { return 0; }
extern "C" int ReplayPicker_GetSelectedSlot(void) { return -1; }
extern "C" int ReplayPicker_Update(void) { return -1; }

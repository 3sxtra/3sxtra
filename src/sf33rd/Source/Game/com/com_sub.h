...
void Forced_Guard(PLW* wk, s16 pGuard_Type);
...
void Check_Super_Art_Conditions(PLW* wk, u16 SA0, u16 SA1, u16 SA2, u16 pTerm_No);
...
void Branch_By_Distance(PLW* wk, s16 Next_Action, s16 Menu, s16 Menu_01, s16 Menu_02, s16 Menu_03);

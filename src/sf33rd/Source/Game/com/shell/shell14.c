...
static void (*const Shell14_Tbl[13])(PLW*);
...
static void Shell14_0000(PLW* wk) {
...
static void Shell14_0001(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Shell14_0002(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Shell14_0003(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Check_Projectile_Impact_Time(wk, 0, 2, 1, -1, -1);
        break;
...
static void Shell14_0004(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Check_Projectile_Impact_Time(wk, 0, 2, 1, -1, -1);
        break;
...
static void Shell14_0005(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Check_Projectile_Impact_Time(wk, 0, 2, 1, -1, -1);
        break;
...
static void Shell14_0006(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Check_Projectile_Impact_Time(wk, 1, 2, 1, -1, -1);
        break;
...
static void Shell14_0007(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Shell14_0008(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Check_Projectile_Impact_Time(wk, 0, 2, 1, -1, -1);
        break;
...
static void Shell14_0009(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Lever_Off(wk);
        break;
...
static void Shell14_0010(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    default:
        End_Pattern(wk);
        break;
...
static void Shell14_0011(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Shell14_0012(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void (*const Shell14_Tbl[13])(PLW*) = { Shell14_0000, Shell14_0001, Shell14_0002, Shell14_0003, Shell14_0004,

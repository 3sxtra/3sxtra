...
static void Pattern05_0000(PLW* wk) {
...
static void Pattern05_0001(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern05_0002(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern05_0003(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern05_0004(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern05_0005(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern05_0006(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Wait(wk, 0x1E);
        break;
...
static void Pattern05_0007(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern05_0008(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern05_0009(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern05_0010(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern05_0011(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern05_0012(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern05_0013(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern05_0014(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern05_0015(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Walk(wk, 0, 0x30, 0);
        break;
...
static void Pattern05_0016(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Walk(wk, 1, 0x30, 0);
        break;
...
static void Pattern05_0017(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern05_0018(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Jump(wk, 1);
        break;
...
static void Pattern05_0020(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern05_0021(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern05_0022(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern05_0023(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern05_0024(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Walk(wk, 0, 0x60, 0);
        break;
...
static void Pattern05_0025(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Walk(wk, 1, 0x60, 0);
        break;
...
static void Pattern05_0026(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern05_0027(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Jump(wk, 0);
        break;
...
static void Pattern05_0028(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern05_0029(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern05_0030(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Adjust_Attack(wk, 9, 0x100);
        break;
...
static void Pattern05_0031(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern05_0032(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern05_0033(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Adjust_Attack(wk, 0xB, 0x10);
        break;
...
static void Pattern05_0034(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern05_0035(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern05_0036(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern05_0037(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Lever_Attack(wk, 8, 1, 0x400);
        break;
...
static void Pattern05_0039(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Command_Attack(wk, 8, 0, 0xB, -1);
        break;
...
static void Pattern05_0040(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern05_0041(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern05_0042(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern05_0043(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern05_0044(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern05_0045(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Search_Back_Term(wk, 0x30, 2, 0xD);
        break;
...
static void Pattern05_0046(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Walk(wk, 0, 0x20, 0);
        break;
...
static void Pattern05_0047(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern05_0048(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    default:
        End_Pattern(wk);
        break;
...
static void Pattern05_0049(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    default:
        End_Pattern(wk);
        break;
...
static void Pattern05_0050(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern05_0051(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern05_0052(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern05_0053(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern05_0054(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern05_0055(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern05_0056(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern05_0057(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern05_0058(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern05_0059(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern05_0060(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern05_0061(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern05_0063(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern05_0064(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern05_0065(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern05_0066(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Provoke(wk, -1);
        break;
...
static void (*const Pattern05_Tbl[67])(PLW*) = {

...
static void Pattern09_0001(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern09_0004(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern09_0005(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern09_0006(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Wait(wk, 0x1E);
        break;
...
static void Pattern09_0007(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern09_0008(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern09_0014(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern09_0015(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Walk(wk, 0, 0x30, 0);
        break;
...
static void Pattern09_0016(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Walk(wk, 1, 0x30, 0);
        break;
...
static void Pattern09_0018(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Jump(wk, 1);
        break;
...
static void Pattern09_0022(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern09_0023(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern09_0024(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Walk(wk, 0, 0x60, 0);
        break;
...
static void Pattern09_0025(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Walk(wk, 1, 0x60, 0);
        break;
...
static void Pattern09_0026(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern09_0027(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Jump(wk, 0);
        break;
...
static void Pattern09_0028(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Approach_Walk(wk, 0x7F, 2);
        break;
...
static void Pattern09_0031(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern09_0032(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern09_0033(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Adjust_Attack(wk, 9, 0x10);
        break;
...
static void Pattern09_0034(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern09_0037(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern09_0038(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern09_0039(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Command_Attack(wk, 8, 0, 0xB, -1);
        break;
...
static void Pattern09_0040(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern09_0042(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern09_0043(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern09_0044(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern09_0045(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern09_0046(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Walk(wk, 0, 0x15, 0);
        break;
...
static void Pattern09_0047(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern09_0048(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern09_0049(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern09_0050(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern09_0051(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern09_0052(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern09_0054(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern09_0055(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern09_0056(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern09_0057(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern09_0060(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern09_0061(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern09_0063(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern09_0064(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern09_0065(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern09_0066(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern09_0067(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Command_Attack(wk, 8, 0x1E, 8, -1);
        break;
...
static void Pattern09_0068(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Command_Attack(wk, 8, 0x1E, 8, -1);
        break;
...
static void Pattern09_0069(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern09_0070(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Look(wk, 0);
        break;
...
static void Pattern09_0071(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Lever_On(wk, 1, 2);
        break;
...
static void Pattern09_0075(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern09_0076(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern09_0077(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern09_0078(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern09_0080(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Lever_On(wk, 1, 2);
        break;
...
static void Pattern09_0081(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern09_0084(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern09_0101(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Lever_On(wk, -1, 2);
        break;
...
static void (*const Pattern09_Tbl[102])(PLW*) = {

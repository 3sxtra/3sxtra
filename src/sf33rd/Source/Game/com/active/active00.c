...
static void Pattern00_0000(PLW* wk) {
...
static void Pattern00_0001(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern00_0002(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern00_0003(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern00_0004(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern00_0005(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern00_0006(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Wait(wk, 0);
        break;
...
static void Pattern00_0007(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern00_0008(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern00_0009(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern00_0010(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern00_0011(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern00_0012(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern00_0013(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern00_0014(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern00_0015(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Walk(wk, 0, 0x30, 0);
        break;
...
static void Pattern00_0016(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern00_0017(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Command_Attack(wk, 8, 0x1E, 8, -1);
        break;
...
static void Pattern00_0018(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern00_0019(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern00_0020(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern00_0021(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern00_0023(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern00_0024(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Walk(wk, 0, 0x60, 0);
        break;
...
static void Pattern00_0025(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern00_0026(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern00_0027(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern00_0028(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern00_0029(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern00_0030(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern00_0031(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern00_0032(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern00_0033(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Adjust_Attack(wk, 9, 0x10);
        break;
...
static void Pattern00_0034(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern00_0035(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Normal_Attack(wk, 8, 0x20);
        break;
...
static void Pattern00_0036(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern00_0037(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern00_0038(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern00_0039(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern00_0040(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Command_Attack(wk, 8, 0x1E, 8, -1);
        break;
...
static void Pattern00_0041(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern00_0042(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern00_0043(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern00_0044(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern00_0045(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern00_0049(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Command_Attack(wk, 8, 0x1E, 8, -1);
        break;
...
static void Pattern00_0050(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern00_0051(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern00_0052(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern00_0055(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Approach_Walk(wk, 0x3B, 2);
        break;
...
static void Pattern00_0056(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Check_Safe_Retreat_Space(wk, 0x60, 2, 0x10);
        break;
...
static void Pattern00_0057(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Check_SA(wk, 2, 0x34);
        break;
...
static void Pattern00_0058(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Jump(wk, 0);
        break;
...
static void Pattern00_0059(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Command_Attack(wk, 8, 1, 0xB, -1);
        break;
...
static void Pattern00_0060(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern00_0061(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Normal_Attack(wk, 9, 0x12);
        break;
...
static void Pattern00_0062(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Normal_Attack(wk, 8, 0x22);
        break;
...
static void Pattern00_0063(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Lever_Attack(wk, 8, 1, 0x20);
        break;
...
static void Pattern00_0064(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Wait(wk, 0xA);
        break;
...
static void Pattern00_0065(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Check_SA(wk, 2, 0x34);
        break;
...
static void Pattern00_0066(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Check_Miscellaneous_Conditions(wk, 0, 6, 0x9A);
        break;
...
static void Pattern00_0067(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Check_Miscellaneous_Conditions(wk, 0, 6, 0x9A);
        break;
...
static void (*const Pattern00_Tbl[68])(PLW*) = {

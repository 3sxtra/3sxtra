...
static void Pattern04_0000(PLW* wk) {
...
static void Pattern04_0001(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern04_0002(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern04_0003(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern04_0004(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern04_0005(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern04_0006(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Wait(wk, 0x1E);
        break;
...
static void Pattern04_0007(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern04_0008(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern04_0009(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern04_0010(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern04_0011(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern04_0012(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern04_0013(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern04_0014(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern04_0015(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Walk(wk, 0, 0x30, 0);
        break;
...
static void Pattern04_0016(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Walk(wk, 1, 0x30, 0);
        break;
...
static void Pattern04_0017(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern04_0018(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern04_0019(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern04_0020(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern04_0021(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern04_0022(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern04_0023(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern04_0024(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Walk(wk, 0, 0x60, 0);
        break;
...
static void Pattern04_0025(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Walk(wk, 1, 0x60, 0);
        break;
...
static void Pattern04_0026(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern04_0027(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Jump(wk, 0);
        break;
...
static void Pattern04_0028(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern04_0029(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern04_0030(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Approach_Walk(wk, 0x47, 2);
        break;
...
static void Pattern04_0031(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern04_0032(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern04_0033(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Approach_Walk(wk, 0x47, 2);
        break;
...
static void Pattern04_0034(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern04_0035(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Normal_Attack(wk, 8, 0x20);
        break;
...
static void Pattern04_0036(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern04_0037(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Approach_Walk(wk, 0x47, 2);
        break;
...
static void Pattern04_0038(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern04_0039(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Command_Attack(wk, 8, 0, 0xB, -1);
        break;
...
static void Pattern04_0040(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Approach_Walk(wk, 0x47, 2);
        break;
...
static void Pattern04_0041(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Approach_Walk(wk, 0x47, 2);
        break;
...
static void Pattern04_0042(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Approach_Walk(wk, 0x47, 2);
        break;
...
static void Pattern04_0043(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern04_0044(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern04_0045(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern04_0046(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Walk(wk, 0, 0x15, 0);
        break;
...
static void Pattern04_0047(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern04_0048(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Approach_Walk(wk, 0x47, 2);
        break;
...
static void Pattern04_0049(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern04_0050(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern04_0051(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern04_0052(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern04_0053(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern04_0054(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern04_0055(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern04_0056(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern04_0057(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern04_0058(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern04_0059(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Command_Attack(wk, 8, 0x20, 8, -1);
        break;
...
static void Pattern04_0060(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern04_0061(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern04_0062(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern04_0063(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern04_0064(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern04_0065(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern04_0066(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern04_0067(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void (*const Pattern04_Tbl[68])(PLW*) = {

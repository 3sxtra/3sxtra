...
static void Pattern15_0000(PLW* wk) {
...
static void Pattern15_0001(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern15_0002(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern15_0003(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern15_0004(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern15_0005(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern15_0006(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Wait(wk, 0x1E);
        break;
...
static void Pattern15_0007(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern15_0008(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Normal_Attack(wk, 8, 0x200);
        break;
...
static void Pattern15_0009(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern15_0010(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern15_0011(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern15_0012(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Normal_Attack(wk, 8, 0x40);
        break;
...
static void Pattern15_0013(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern15_0014(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern15_0015(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Walk(wk, 0, 0x30, 0);
        break;
...
static void Pattern15_0016(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern15_0017(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern15_0018(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern15_0019(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern15_0020(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern15_0021(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern15_0022(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern15_0023(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern15_0024(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Walk(wk, 0, 0x60, 0);
        break;
...
static void Pattern15_0025(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Search_Back_Term(wk, 0x30, 6, 0xF);
        break;
...
static void Pattern15_0026(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern15_0027(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Jump(wk, 0);
        break;
...
static void Pattern15_0028(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern15_0029(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern15_0030(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern15_0031(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern15_0032(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern15_0033(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Adjust_Attack(wk, 8, 0x100);
        break;
...
static void Pattern15_0034(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern15_0035(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Normal_Attack(wk, 8, 0x20);
        break;
...
static void Pattern15_0036(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern15_0037(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Command_Attack(wk, 8, 0x1E, 0xA, -1);
        break;
...
static void Pattern15_0038(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern15_0039(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Command_Attack(wk, 8, 0x1E, 0xA, -1);
        break;
...
static void Pattern15_0040(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern15_0041(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern15_0042(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern15_0043(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern15_0044(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern15_0045(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Walk(wk, 0, 0x20, 0);
        break;
...
static void Pattern15_0046(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern15_0047(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern15_0048(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern15_0049(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern15_0050(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern15_0051(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Command_Attack(wk, 8, 0x1F, 0xA, -1);
        break;
...
static void Pattern15_0052(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern15_0053(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern15_0054(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern15_0055(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Lever_Off(wk);
        break;
...
static void Pattern15_0056(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern15_0057(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern15_0058(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern15_0059(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern15_0060(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern15_0061(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Check_EX(wk, 2, 2);
        break;
...
static void Pattern15_0062(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern15_0063(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern15_0064(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Command_Attack(wk, 8, 0x1E, 8, -1);
        break;
...
static void Pattern15_0065(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern15_0066(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern15_0067(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern15_0068(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Rapid_Command_Attack(wk, 8, 0x4D, 0x100, 0x78);
        break;
...
static void (*const Pattern15_Tbl[69])(PLW*) = {

...
static void Pattern02_0000(PLW* wk) {
...
static void Pattern02_0001(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern02_0002(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern02_0003(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern02_0004(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern02_0005(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern02_0006(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Wait(wk, 0x1E);
        break;
...
static void Pattern02_0008(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern02_0009(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Jump_Command_Attack(wk, 8, 0x1C, 8, -1);
        break;
...
static void Pattern02_0010(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern02_0011(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern02_0012(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern02_0013(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern02_0014(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern02_0015(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Walk(wk, 0, 0x30, 0);
        break;
...
static void Pattern02_0016(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Walk(wk, 1, 0x30, 0);
        break;
...
static void Pattern02_0017(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern02_0018(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Jump(wk, 1);
        break;
...
static void Pattern02_0021(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern02_0022(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern02_0023(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern02_0024(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Walk(wk, 0, 0x60, 0);
        break;
...
static void Pattern02_0025(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Walk(wk, 1, 0x60, 0);
        break;
...
static void Pattern02_0026(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern02_0027(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Jump(wk, 0);
        break;
...
static void Pattern02_0028(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Approach_Walk(wk, 0x7F, 2);
        break;
...
static void Pattern02_0029(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern02_0030(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Adjust_Attack(wk, 9, 0x100);
        break;
...
static void Pattern02_0031(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern02_0032(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern02_0033(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern02_0034(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern02_0035(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern02_0036(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern02_0037(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern02_0038(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern02_0039(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Command_Attack(wk, 8, 0, 0xB, -1);
        break;
...
static void Pattern02_0040(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern02_0041(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern02_0042(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern02_0043(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern02_0044(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern02_0045(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern02_0046(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Walk(wk, 0, 0x15, 0);
        break;
...
static void Pattern02_0047(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern02_0049(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern02_0050(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern02_0051(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern02_0052(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern02_0053(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern02_0054(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern02_0055(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern02_0056(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern02_0057(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern02_0058(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Command_Attack(wk, 8, 0x8015, 9, -1);
        break;
...
static void Pattern02_0059(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Command_Attack(wk, 8, 0x8015, 9, -1);
        break;
...
static void Pattern02_0060(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern02_0061(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    default:
        End_Pattern(wk);
    }
...
static void Pattern02_0063(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern02_0064(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern02_0065(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern02_0066(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Command_Attack(wk, 8, 0x1D, 0xA, -1);
        break;
...
static void Pattern02_0067(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Command_Attack(wk, 8, 0x1D, 9, -1);
        break;
...
static void Pattern02_0068(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Command_Attack(wk, 8, 0x1D, 8, -1);
        break;
...
static void Pattern02_0069(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Command_Attack(wk, 8, 0, 0xB, -1);
        break;
...
static void Pattern02_0070(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern02_0072(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern02_0073(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern02_0074(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Lever_Attack(wk, 8, 0, 0x40);
        break;
...
static void (*const Pattern02_Tbl[75])(PLW*) = {

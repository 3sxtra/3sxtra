...
static void Pattern13_0000(PLW* wk) {
...
static void Pattern13_0001(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern13_0002(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern13_0003(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern13_0004(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern13_0005(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern13_0006(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Wait(wk, 0x1E);
        break;
...
static void Pattern13_0007(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern13_0008(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern13_0009(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern13_0010(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern13_0011(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Lever_On(wk, 1, 2);
        break;
...
static void Pattern13_0012(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern13_0013(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern13_0014(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern13_0015(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Walk(wk, 0, 0x30, 0);
        break;
...
static void Pattern13_0016(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern13_0017(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Command_Attack(wk, 8, 0x1E, 8, -1);
        break;
...
static void Pattern13_0018(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern13_0019(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern13_0020(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern13_0021(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern13_0023(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern13_0024(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Walk(wk, 0, 0x60, 0);
        break;
...
static void Pattern13_0025(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern13_0026(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern13_0027(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern13_0028(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Approach_Walk(wk, 0x7B, 2);
        break;
...
static void Pattern13_0029(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern13_0030(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern13_0031(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern13_0033(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern13_0034(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern13_0035(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Normal_Attack(wk, 8, 0x20);
        break;
...
static void Pattern13_0036(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern13_0038(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Lever_On(wk, 1, 0);
        break;
...
static void Pattern13_0039(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern13_0040(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Command_Attack(wk, 8, 0x1E, 8, -1);
        break;
...
static void Pattern13_0041(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Command_Attack(wk, 8, 0x1F, 9, -1);
        break;
...
static void Pattern13_0042(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Lever_On(wk, 1, 2);
        break;
...
static void Pattern13_0043(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern13_0044(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern13_0045(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern13_0046(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern13_0047(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern13_0048(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Command_Attack(wk, 8, 0x8014, 0xA, -1);
        break;
...
static void Pattern13_0049(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Command_Attack(wk, 8, 0x1E, 8, -1);
        break;
...
static void Pattern13_0050(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern13_0051(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern13_0055(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Approach_Walk(wk, 0x33, 2);
        break;
...
static void Pattern13_0056(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Search_Back_Term(wk, 0x60, 2, 0x10);
        break;
...
static void Pattern13_0057(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Command_Attack(wk, 8, 0x8014, 0xA, -1);
        break;
...
static void Pattern13_0058(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern13_0059(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern13_0060(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern13_0061(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern13_0062(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern13_0063(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern13_0064(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Command_Attack(wk, 8, 0x8016, 9, -1);
        break;
...
static void Pattern13_0065(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Command_Attack(wk, 8, 0x8016, 0xA, -1);
        break;
...
static void Pattern13_0066(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Command_Attack(wk, 8, 0x8016, 0xA, -1);
        break;
...
static void Pattern13_0067(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern13_0069(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern13_0070(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern13_0071(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern13_0072(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern13_0073(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern13_0074(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Normal_Attack(wk, 8, 0x20);
        break;
...
static void Pattern13_0075(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern13_0076(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern13_0077(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void (*const Pattern13_Tbl[81])(PLW*) = {

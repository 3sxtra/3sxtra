...
static void Pattern08_0000(PLW* wk) {
...
static void Pattern08_0001(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern08_0002(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern08_0003(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern08_0004(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern08_0005(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern08_0006(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Wait(wk, 0);
        break;
...
static void Pattern08_0007(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern08_0008(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern08_0009(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern08_0010(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Normal_Attack(wk, 8, 0x402);
        break;
...
static void Pattern08_0011(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Normal_Attack(wk, 9, 0x102);
        break;
...
static void Pattern08_0012(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern08_0013(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern08_0014(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern08_0015(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Walk(wk, 0, 0x30, 0);
        break;
...
static void Pattern08_0016(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Walk(wk, 1, 0x30, 0);
        break;
...
static void Pattern08_0017(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern08_0018(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern08_0020(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern08_0021(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        J_Command_Attack(wk, 8, 0x1D, 0xA, -1);
        break;
...
static void Pattern08_0022(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern08_0023(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern08_0024(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Walk(wk, 0, 0x60, 0);
        break;
...
static void Pattern08_0025(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Walk(wk, 1, 0x60, 0);
        break;
...
static void Pattern08_0026(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern08_0027(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Jump(wk, 0);
        break;
...
static void Pattern08_0028(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern08_0029(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Normal_Attack(wk, 9, 0x102);
        break;
...
static void Pattern08_0030(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Normal_Attack(wk, 9, 0x100);
        break;
...
static void Pattern08_0031(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern08_0032(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern08_0033(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern08_0034(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern08_0035(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern08_0036(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern08_0037(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern08_0039(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Command_Attack(wk, 8, 0, 0xB, -1);
        break;
...
static void Pattern08_0040(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern08_0041(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Normal_Attack(wk, 0xB, 0x40);
        break;
...
static void Pattern08_0042(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern08_0043(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern08_0044(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern08_0045(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern08_0046(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Walk(wk, 0, 0x15, 0);
        break;
...
static void Pattern08_0047(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Walk(wk, 1, 0x20, 0);
        break;
...
static void Pattern08_0048(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Wait(wk, 0x3C);
        break;
...
static void Pattern08_0049(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Command_Attack(wk, 8, 0, 0xA, -1);
        break;
...
static void Pattern08_0050(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern08_0051(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern08_0052(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Hi_Jump_Attack_Term(wk, -0x7F98, -0x7FB8, 8, 0x40, 0, -1, -0x7FF0, 0x10);
        break;
...
static void Pattern08_0054(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        J_Command_Attack(wk, 8, 0x1C, 0xA, -1);
        break;
...
static void Pattern08_0055(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Search_Back_Term(wk, 0x60, 1, -1);
        break;
...
static void Pattern08_0056(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Search_Back_Term(wk, 0x60, 1, -1);
        break;
...
static void Pattern08_0057(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern08_0058(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern08_0059(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern08_0060(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    default:
        End_Pattern(wk);
        break;
...
static void Pattern08_0061(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Command_Attack(wk, 8, 1, 0xA, -1);
        break;
...
static void Pattern08_0063(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    default:
        End_Pattern(wk);
        break;
...
static void Pattern08_0064(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern08_0065(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern08_0066(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern08_0067(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern08_0068(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern08_0069(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
        Jump(wk, 0);
        break;
...
static void Pattern08_0070(PLW* wk) {
    switch (CP_Index[wk->wu.id][0]) {
    case 0:
...
static void (*const Pattern08_Tbl[71])(PLW*) = {

...
static void Pattern10_0000(PLW* wk) {
...
static void Pattern10_0001(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern10_0002(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern10_0003(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern10_0004(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern10_0005(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern10_0006(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Wait(wk, 0x1E);
        break;
...
static void Pattern10_0007(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern10_0008(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern10_0009(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern10_0010(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern10_0011(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern10_0012(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern10_0013(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern10_0014(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern10_0015(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Walk(wk, 0, 0x30, 0);
        break;
...
static void Pattern10_0016(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern10_0017(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Enable_Overhead_Attack_Flag(wk);
        break;
...
static void Pattern10_0018(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern10_0019(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Enable_Overhead_Attack_Flag(wk);
        break;
...
static void Pattern10_0020(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Lever_Attack(wk, 8, 0, 0x200);
        break;
...
static void Pattern10_0021(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern10_0022(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern10_0023(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern10_0024(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern10_0025(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Check_Safe_Retreat_Space(wk, 0x70, 2, 0);
        break;
...
static void Pattern10_0026(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern10_0027(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Jump(wk, 0);
        break;
...
static void Pattern10_0028(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern10_0029(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern10_0030(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Adjust_Attack(wk, 9, 0x10);
        break;
...
static void Pattern10_0031(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern10_0032(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern10_0033(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Adjust_Attack(wk, 9, 0x10);
        break;
...
static void Pattern10_0034(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern10_0035(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Normal_Attack(wk, 8, 0x20);
        break;
...
static void Pattern10_0036(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern10_0037(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern10_0038(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern10_0039(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Command_Attack(wk, 8, 0x20, 8, -1);
        break;
...
static void Pattern10_0040(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern10_0041(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern10_0042(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern10_0043(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern10_0044(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern10_0045(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Walk(wk, 0, 0x14, 0);
        break;
...
static void Pattern10_0046(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern10_0047(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern10_0048(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern10_0049(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern10_0050(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern10_0051(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern10_0052(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern10_0053(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern10_0054(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern10_0055(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern10_0056(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern10_0057(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern10_0058(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern10_0059(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Check_Safe_Retreat_Space(wk, 0x70, 2, 0x11);
        break;
...
static void Pattern10_0060(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Check_Safe_Retreat_Space(wk, 0x70, 2, 0);
        break;
...
static void Pattern10_0061(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Check_Safe_Retreat_Space(wk, 0x70, 2, 0);
        break;
...
static void Pattern10_0062(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern10_0063(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Lever_Attack(wk, 8, 0, 0x200);
        break;
...
static void Pattern10_0064(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern10_0065(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern10_0066(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern10_0067(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern10_0068(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
...
static void Pattern10_0069(PLW* wk) {
    switch (g_state.CP_Index[wk->wu.id][0]) {
    case 0:
        Command_Attack(wk, 8, 0x1D, 8, -1);
        break;
...
static void (*const Pattern10_Tbl[70])(PLW*) = {

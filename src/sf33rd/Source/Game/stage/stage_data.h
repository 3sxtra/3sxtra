...
extern s16 y_fixed_pos;
extern u8 y_fixed_flag;
extern u8 c_number;
extern u8 char_rewrite;
extern u8 g_number[2];
extern u8 bg_rewrite[2];
extern u8 palette_swap;
extern const u16* scr_bcm[4];
extern s16 screen_adjust_y;
extern s16 screen_adjust_x;
extern u16 zoom_add;
extern s16 ls_cnt1;
extern s8 bg_app;

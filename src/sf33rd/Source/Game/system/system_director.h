...
typedef enum Dipswitch {
    ...
    DIP_STAND_PARRY_DISABLED = 1 << 8,
    DIP_CROUCH_PARRY_DISABLED = 1 << 9,
    ...
    DIP_GUARD_CHECK_ENABLED = 1 << 26,
    DIP_GROUND_SPECIAL_DISABLED = 1 << 28,
    DIP_AIR_SPECIAL_DISABLED = 1 << 29,
    DIP_GROUND_SUPER_ART_DISABLED = 1 << 30,
    DIP_AIR_SUPER_ART_DISABLED = 1 << 31,
} Dipswitch;
...
typedef enum Dipswitch2 {
    ...
    DIP2_SA_GAUGE_INCREMENTAL_FILL_DISABLED = 1 << 16,
    DIP2_SA_GAUGE_ROUND_RESET_DISABLED = 1 << 17,
    DIP2_SA_GAUGE_MAX_START_DISABLED = 1 << 18,
    DIP2_SA_GAUGE_AUTOFILL_DISABLED = 1 << 19,
    DIP2_GROUND_CHAIN_COMBO_DISABLED = 1 << 20,
    DIP2_AIR_CHAIN_COMBO_DISABLED = 1 << 21,
    DIP2_CHAIN_INTO_SPECIAL_DISABLED = 1 << 22,
    DIP2_CHAIN_INTO_SUPER_ART_DISABLED = 1 << 23,

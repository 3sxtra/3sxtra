/**
 * @file workuser_system.h
 * @brief Extern declarations for gameplay globals - System, Engine and general state
 */
#ifndef WORKUSER_SYSTEM_H
#define WORKUSER_SYSTEM_H
...
extern u8 entry_phase[4];
extern u8 manage_phase[4];
// Game routine indices
extern u8 demo_phase[4];
extern u8 message_phase[4];
extern u8 Exit_No;
extern u8 SP_No[2][4];
...
extern s16 fsm_timer;
extern s16 demo_timer_global;
extern s16 entry_timer;
extern s16 F_Timer[2];
extern s16 ENTRY_X;
extern s16 manage_timer;
extern s16 select_timer_legacy;
...
extern s16 bonus_stage2_offset[3];

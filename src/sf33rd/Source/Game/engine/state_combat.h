 ...
 */
#ifndef STATE_COMBAT_H
#define STATE_COMBAT_H
...
extern s8 mutual_trade_flag;
extern u8 parry_counter[2];
extern u8 parry_bonus_r[2];
extern u8 parry_ctr_vs[2][2];
extern u8 parry_ctr_ori[2];

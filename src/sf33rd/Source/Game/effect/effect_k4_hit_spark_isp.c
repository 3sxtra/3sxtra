...
const s16 effK4_isp_x_offset[4][8] = { { 0, 128, 256, 384, -128, -256, -384, -512 },
                                       { 0, 128, 256, 384, -128, -256, -512, -768 },
                                       { 0, 256, 384, 512, -256, -512, -768, -1024 },
                                       { 0, 256, 512, -256, -512, -768, -1024, -1280 } };

const s16 effK4_isp_y_offset[4][8] = { { 0, 0, 128, 128, 256, 256, 384, -128 },
...
static void get_init_speed_and_timer_effK4(State* wk) {
    ...
    data[3] = -96;
    ix = random_16() & 7;
    data[0] += effK4_isp_x_offset[wk->damage_attack_level][ix];
    ix = random_16() & 7;
    data[2] += effK4_isp_y_offset[wk->damage_attack_level][ix];

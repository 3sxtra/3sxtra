...
static void effe6_0000(State_Other* ewk);
static void effe6_0001(State_Other* ewk);
static void effe6_0002(State_Other* ewk);
static void effe6_0003(State_Other* ewk);
static void effe6_0004(State_Other* ewk);
static void effe6_0005(State_Other* ewk);
static void effe6_0006(State_Other* ewk);
static void effe6_0007(State_Other* ewk);
static void effe6_0009(State_Other* ewk);
static void effe6_0010(State_Other* ewk);
static void effe6_0010_sub(State_Other* ewk);
static void effe6_0011(State_Other* ewk);
static void effe6_0012(State_Other* ewk);
static void effe6_0013(State_Other* ewk);
static void effe6_0014(State_Other* ewk);
static void effe6_0015(State_Other* ewk);
static void effe6_0016(State_Other* ewk);
static void effe6_0017(State_Other* ewk);
static void effe6_0018(State_Other* ewk);
static void effe6_0019(State_Other* ewk);
static void effe6_0020(State_Other* ewk);
static void effe6_0021(State_Other* ewk);
static void effe6_0022(State_Other* ewk);
static void effe6_0023(State_Other* ewk);
static void effe6_0024(State_Other* ewk);
static void effe6_0025(State_Other* ewk);
static void effe6_0026(State_Other* ewk);
static void effe6_0027(State_Other* ewk);
static void effe6_0028(State_Other* ewk);
static void effe6_0029(State_Other* ewk);
static void effe6_0030(State_Other* ewk);
static void effe6_0031(State_Other* ewk);
static void effe6_0032(State_Other* ewk);
static void effe6_0033(State_Other* ewk);
static void effe6_init_common(State_Other* ewk);
...
static void effe6_0000(State_Other* ewk) {
    ...
    case 1:
        ...
        if (g_state.End_PL == 17) {
            switch (ewk->wu.type) {
            case 0x74:
                ewk->wu.my_col_code = g_state.bg_w.bgw[0].l_limit ? 0x12E : 0x12C;
                break;

            case 0x75:
                ewk->wu.my_col_code = g_state.bg_w.bgw[0].l_limit ? 0x130 : 0x12C;
                break;

            case 0x76:
                ewk->wu.my_col_code = g_state.bg_w.bgw[0].l_limit ? 0x132 : 0x12C;
                break;

            case 0x78:
                ewk->wu.my_col_code = g_state.bg_w.bgw[0].l_limit ? 0x138 : 0x12C;
                break;

            case 0xA2:
                ewk->wu.my_col_code = g_state.bg_w.bgw[0].l_limit ? 0x12D : 0x12C;
                break;
            }
        }
    ...
    case 1:
        if (ewk->wu.old_routine_no[6] < g_state.end_w.r_no_2) {
            ...
            if (ewk->wu.old_routine_no[5] <= 0) {
                ewk->wu.disp_flag ^= 1;
                ewk->wu.old_routine_no[5] = ewk->wu.old_routine_no[2];
            }
        }
...
static void effe6_0006(State_Other* ewk) {
    ...
    case 0:
        effe6_init_common(ewk);
        ewk->wu.old_routine_no[2] = ewk->wu.xyz[0].disp.pos;
        disp_pos_trans_entry(ewk);
        break;
    ...
    case 1:
        if (ewk->wu.old_routine_no[6] < g_state.end_w.r_no_2) {
            ...
            if (ewk->wu.type == 73) {
                work = ewk->wu.old_routine_no[2] - 704;
            } else {
                work = ewk->wu.old_routine_no[2] - 384;
            }

            if (work > g_state.bg_w.bgw[ewk->wu.my_family - 1].xy[0].disp.pos) {
                ewk->wu.routine_no[2] = 99;
            }
        }
...
static void effe6_0009(State_Other* ewk) {
    ...
    case 1:
        ...
        if (ewk->wu.xyz[1].disp.pos < -199) {
            ewk->wu.routine_no[1]++;
            g_state.bg_w.bgw[0].r_no_1++;
            g_state.bg_w.bgw[1].r_no_1++;
        }
...
static void effe6_0010_sub(State_Other* ewk) {
    ...
    if (ewk->wu.old_routine_no[2] >= 8) {
        ewk->wu.routine_no[1]++;
    }

    ewk->wu.old_routine_no[2] &= 7;
    ewk->wu.extra_col = effe6_0010_col_tbl[ewk->wu.old_routine_no[2]];
}
...
static void effe6_0014(State_Other* ewk) {
    ...
    case 2:
        ...
        if (ewk->wu.old_routine_no[2] < 0) {
            ewk->wu.old_routine_no[2] = 2;
            ewk->wu.mirror_scale.size.x--;
            ewk->wu.mirror_scale.size.y--;

            if (ewk->wu.mirror_scale.size.x < 60) {
                ewk->wu.routine_no[1]++;
                set_char_move_init2(&ewk->wu, 0, 21, 9, 0);
                ewk->wu.old_routine_no[2] = 4;
            } else {
                ewk->wu.old_routine_no[2] = 3;
            }
        }
    ...
    case 3:
        ...
        if (ewk->wu.old_routine_no[2] < 0) {
            ...
            if (ewk->wu.mirror_scale.size.x < 56) {
                ewk->wu.routine_no[1]++;
...
static void effe6_0015(State_Other* ewk) {
    ...
    case 0:
        effe6_init_common(ewk);
        ewk->wu.old_routine_no[2] = 40;
        cal_all_speed_data(&ewk->wu, ewk->wu.old_routine_no[2], 544, 48, 2, 2);
        break;
    ...
    case 3:
        ...
        if (ewk->wu.cg_type == 9) {
            if (ewk->wu.routine_no[1] == 1) {
                ewk->wu.old_routine_no[2] = 10;
            } else {
                ewk->wu.old_routine_no[2] = 80;
            }
    ...
    case 1:
        if (ewk->wu.type == 150) {
            ...
            if (work & 0x10) {
                ...
                if (ewk->wu.old_routine_no[2] >= 7) {
                    ewk->wu.old_routine_no[2] = 0;
                }
            }

            switch (ewk->wu.old_routine_no[2]) {
            case 0:
...
static void effe6_0030(State_Other* ewk) {
    ...
    case 1:
        if (g_state.end_w.r_no_2 == 4 && g_state.bg_w.bgw[0].r_no_1 == 1) {
            switch (g_state.bg_w.bgw[0].l_limit) {
            case 0:
...
static void effe6_0031(State_Other* ewk) {
    ...
    case 0:
        effe6_init_common(ewk);
        ewk->wu.old_routine_no[5] = gill_time[0];
        disp_pos_trans_entry(ewk);
        break;
    ...
    case 2:
        if (end_etc_flag) {
            ewk->wu.routine_no[1]++;
            ewk->wu.old_routine_no[5] = gill_time[1];
            end_etc_flag = 0;
        }
...
static void effe6_0032(State_Other* ewk) {
    ...
    case 0:
        effe6_init_common(ewk);
        ewk->wu.old_routine_no[5] = gill_time[2];
        ewk->wu.old_routine_no[2] = ewk->wu.old_routine_no[7] = 0;
        ...
        case 178:
            ...
            ewk->wu.old_routine_no[5] = gill_time[9];
            break;
        }
    ...
    case 2:
        ...
        ewk->wu.routine_no[1]++;
        ewk->wu.old_routine_no[5] = gill_time[3];
        disp_pos_trans_entry(ewk);
    ...
    case 10:
        ...
        ewk->wu.routine_no[1]++;
        ewk->wu.old_routine_no[5] = gill_time[4];
        char_move(&ewk->wu);
        disp_pos_trans_entry(ewk);
        break;
...
static void effe6_0033(State_Other* ewk) {
    ...
    case 0:
        effe6_init_common(ewk);
        ewk->wu.old_routine_no[5] = end_0_1_time[0] + gill_time[0];
...
s32 effect_E6_init(u8 char_num) {
    ...
    ewk->wu.old_routine_no[1] = ewk->wu.char_index - 1;

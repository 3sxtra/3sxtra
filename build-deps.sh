...
if [ -f "$MINIZIP_NG_BUILD/lib/libminizip-ng.a" ] || [ -f "$MINIZIP_NG_BUILD/lib64/libminizip-ng.a" ]; then
...
if [ -f "$TF_PSA_CRYPTO_BUILD/lib/libtfpsacrypto.a" ] || [ -f "$TF_PSA_CRYPTO_BUILD/lib64/libtfpsacrypto.a" ]; then

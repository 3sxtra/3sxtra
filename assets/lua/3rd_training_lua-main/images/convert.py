...
for color, color_code in colors.items():
    for char in utf["en"]:
        ...
        subprocess.Popen(
            ["bash", "./text_to_image.sh", char, filename, size, color_code, "en"],
            cwd=cwd,
        )
        data.setdefault(key, {})
    ...
    for char in utf["jp"]:
        ...
        subprocess.Popen(
            ["bash", "./text_to_image.sh", char, filename, size, color_code, "jp"],
            cwd=cwd,
        )
        data.setdefault(key, {})
    ...
    for char in utf["jp_ext"]:
        ...
        subprocess.Popen(
            ["bash", "./text_to_image.sh", char, filename, size, color_code, "jp_ext"],
            cwd=cwd,
        )
        data.setdefault(key, {})
        data[key]["jp"] = base_path + filename + ".png"
    ...
    for char in utf["score"]:
        ...
        subprocess.Popen(
            ["bash", "./text_to_image.sh", char, filename, size, color_code, "score"],
            cwd=cwd,
        )
        data.setdefault(key, {})
